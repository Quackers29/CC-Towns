local ButtonConfig = {
    ...
    {id = "Up",width = 3,x = -1,y = 1,colorOn = colors.yellow,colorOff = colors.gray,charOn = "+",action = function(x) handleCSVItem(x) goToPage("upgrades") end,enabled = false, type = "button",page = "display"},
}
