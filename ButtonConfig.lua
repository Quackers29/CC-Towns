...
--population
{id = "touristOut",width = 3,x = -1,y = 2,colorOn = colors.yellow,colorOff = colors.gray,charOn = "+",action = function(x) handlePop("touristOuput") end,enabled = false, type = "button",page = "Pop_Settings"},
